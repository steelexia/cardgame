...
UIColor* COLOUR_INTERFACE_BLUE, *COLOUR_INTERFACE_BLUE_PRESSED, *COLOUR_INTERFACE_BLUE_TRANSPARENT, *COLOUR_INTERFACE_BLUE_TOGGLE, *COLOUR_INTERFACE_BLUE_LIGHT, *COLOUR_INTERFACE_GRAY;
...
UIImage*RESOURCE_ICON_IMAGE, *POINTS_ICON_IMAGE, *GOLD_ICON_IMAGE, *LIKE_ICON_IMAGE, *CARD_ICON_GRAY_IMAGE, *CARD_ICON_IMAGE, *ADD_ICON_IMAGE;